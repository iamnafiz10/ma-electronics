                ...
                <div className="mt-4 bg-white border border-gray-200 rounded p-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div className="mt-4">
                                <input type="file" accept="image/*" onChange={p.onPickImage}
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700 mb-1">Email Address
                                    *</label>
                            ...
                            <button onClick={p.save} disabled={p.saving}
                                    className="w-full bg-primary hover:bg-dark-primary cursor-pointer text-[14px] text-white py-2 rounded">
