...
import profiReact, {useEffect, useState} from "react";
...
const menuItems: MenuItem[] = [
    ...
    },
    {
        ...
        path: "/admin/settings",
        subItems: [
            {id: 101, title: "Update Profile", path: "/admin/dashboard/settings/profile"},
            {id: 102, title: "Change Password", path: "/admin/dashboard/settings/security"},
        ],
    },
];
