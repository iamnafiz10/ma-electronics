...
const AdminHeader: React.FC = () => {
  ...
  return (
    <header className="flex justify-between items-center h-[48px] px-4 bg-white border-b border-gray-200 md:relative fixed top-0 left-0 right-0 z-20">
      <div />
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        {dropdownOpen && (
          <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded shadow-sm z-50 overflow-hidden">
